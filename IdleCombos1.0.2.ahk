#include JSON.ahk
;Added in 1.0.2:
;-Date of Next TGP drop
;-Open Support Ticket link
;-Choose install directory
;-Achievement details for:			(not tested)
;---Asharra, Gromma, Krond, Regis
...
;---check gromma abc / krond 123
;-missing feats
;-missing patron variants
;-zorbu values?
...
class MyGui {
	...
	__New()
	{
		...
		Gui, MyWindow:Add, Text, vNextTGPDrop x+10 w185, % NextTGPDrop
...
CheckAchievements() {
	...
	AchievementInfo := "Locked Achievement Details`n"
}
